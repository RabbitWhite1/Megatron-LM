...
GPT_MODEL_ARGS=(
    ...
    --cp-comm-type all_gather # We choose all_gather because p2p is not supported in Dynamo.
    # --deterministic-mode
)
...
export FORCE_IN_ONNX_EXPORT_MODE=1
export NVTE_ONNX_EXPORT=1

export FORCE_CP_WHEN_SIZE_IS_ONE=1
